...
# print("Variable:"+AZURE_STORAGE_CONNECTION_STRING, AZURE_CONTAINER_NAME)
# # Mock API endpoint
...
# print("Variable:"+storage_account_name, client_id, tenant_id, client_secret)
...
# Paste your SAS token (excluding the leading '?')
sas_token = ""
...
def upload_file_to_azure(file):
    ...
    try:
        ...
        st.title("Upload File to Azure Blob Storage Using SAS Token")
